        ...
        <nav>
            <ul>
                <li className="relative flex">
                    <Link tabIndex={0} href="/perseverance-new" className={`navlink ${lastPathSegment === 'perseverance' ? 'active' : ''}`} prefetch={true}>Perseverance</Link>
                    <div className={`navdivider ${lastPathSegment === 'curiosity' ? 'hidden' : ''}`}></div>
                </li>
                <li className="relative flex">
                    <Link tabIndex={0} href="/curiosity-new" className={`navlink ${lastPathSegment === 'curiosity' ? 'active' : ''}`} prefetch={true}>Curiosity</Link>
                    <div className={`navdivider${lastPathSegment === 'opportunity' ? 'hidden' : ''}`}></div>
                </li>
                <li className="relative flex">
                    <Link tabIndex={0} href="/opportunity-new" className={`navlink ${lastPathSegment === 'opportunity' ? 'active' : ''}`} prefetch={true}>Opportunity</Link>
